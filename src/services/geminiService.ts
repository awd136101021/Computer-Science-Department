...
const model = "gemini-2.0-flash-exp"; // Updated to a known valid model or keep theirs if valid. They used gemini-2.5-flash which might be experimental? keeping it to match or fall back to standard. Note: 1.5 is standard. 2.0 is experimental.
