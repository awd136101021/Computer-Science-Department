...
function About() {
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 pt-32 transition-opacity duration-1000 ${isVisible ? "opacity-100" : "opacity-0"}`}
    >
      {/* Hero Section */}
      ...
      <section className="max-w-6xl mx-auto px-6 mb-16 mt-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-extrabold text-[#003366] mb-4 border-b-2 border-[#ffcc00] inline-block pb-1">
            Meet Our Team
          </h2>
      ...
      <section className="max-w-6xl mx-auto px-6 mb-20">
        <div className="bg-white rounded-2xl shadow-2xl p-10 border-t-4 border-t-[#ffcc00] hover:shadow-3xl transition-all duration-300">
          <h2 className="text-4xl font-extrabold text-[#003366] mb-10 text-center border-b-2 border-gray-100 pb-4">
            Technologies We Use
          </h2>
